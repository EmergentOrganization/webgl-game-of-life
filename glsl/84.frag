...
void main() {
	...
	if(sum_0 >= 23 && sum_0 <= 23) 		{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 29 && sum_0 <= 29) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 31 && sum_0 <= 31) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 37 && sum_0 <= 37) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 41 && sum_0 <= 41) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 43 && sum_0 <= 43) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 47 && sum_0 <= 47) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 51 && sum_0 <= 51) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
