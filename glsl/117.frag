...
float s3 = 		getR(vec2(7.0, -1.0)) +
	...
	if(cgol >= 5 && cgol <= 7) {gl_FragColor = vec4(1.0, 0.3, 0.0, 1.0);}
    if(cgol >= 3 && cgol <= 3) {gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);}
    	
	if(sum_0 >= 79 && sum_0 <= 84) { gl_FragColor = vec4(1.0, 0.8, 0.2, 1.0); }	
	if(sum_0 >= 36 && sum_0 <= 36) { gl_FragColor = vec4(1.0, 0.6, 0.3, 1.0); }	
	if(sum_0 >= 19 && sum_0 <= 19) { gl_FragColor = vec4(1.0, 0.6, 0.3, 1.0); }	
	if(sum_0 >= 117 && sum_0 <= 129) { gl_FragColor = vec4(1.0, 0.0, 1.0, 1.0); }	
	...
	if(sum_0 >= 22 && sum_0 <= 34) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
