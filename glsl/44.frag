...
float s3 = 		getR(vec2(7.0, -1.0)) +
    ...
    //if(cgol >= 3 && cgol <= 3) {gl_FragColor = vec4(0.0, 0.0, 4.0, 1.0);}
    	
	if(sum_0 >= 22 && sum_0 <= 33) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
	if(sum_0 >= 111 && sum_0 <= 112) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 71 && sum_0 <= 77) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 143) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
