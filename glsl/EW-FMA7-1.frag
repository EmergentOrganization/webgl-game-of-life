...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 30 && sum_0 <= 155) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s10 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_2 >= 190) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 316 && sum_2 <= 320) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	//if(sum_2 == 62) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	
	//if(sum_2 <= 28) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
