...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_2 >= 20 && sum_2 <= 50) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 43 && sum_2 <= 49) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_2 >= 49 && sum_2 <= 50) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 89 && sum_2 <= 112) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s8 = 		getR(vec2(3.0, -2.0)) +
	...
	if(sum_4 >= 15 && sum_4 <= 15) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
