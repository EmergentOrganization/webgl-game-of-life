...
//Get gliders to be birthed from wave's crystal form
	...
	//if(sum_0 >= 69 && sum_0 <= 70) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 91 && sum_0 <= 120) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 16 && sum_1 <= 17) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
