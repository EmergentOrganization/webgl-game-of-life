...
//Get gliders to be birthed from wave's crystal form
	...
	//if(sum_0 <= 60) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }

	if(sum_0 >= 110 && sum_0 <= 149) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 87 && sum_0 <= 119) { gl_FragColor = vec4(1.0, 0.3, 0.0, 1.0); }
	if(sum_0 >= 93 && sum_0 <= 109) { gl_FragColor = vec4(1.0, 0.6, 0.0, 1.0); }

	if(sum_0 >= 65 && sum_0 <= 66) { gl_FragColor = vec4(1.0, 0.4, 0.0, 1.0); }
	if(sum_0 >= 79 && sum_0 <= 80) { gl_FragColor = vec4(1.0, 0.0, 0.4, 1.0); }	
	if(sum_0 == 30) { gl_FragColor = vec4(1.0, 0.4, 0.3, 1.0); }
	
	if(sum_0 >= 137) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 32 && sum_0 <= 71) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//EDGE_2
