...
float s0 = 
	...
	if(sum_0 >= 27 && sum_0 <= 32) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); } 
	if(sum_0 > 39 && sum_0 < 46) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 19 && sum_0 <= 24) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
//:17,17,1,
	...
	if(sum_1 >= 240 && sum_1 <= 275) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 78 && sum_1 <= 80) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 55 && sum_1 <= 59) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 39 && sum_1 <= 39) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 19 && sum_1 <= 19) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }

	//if(sum_1 >= 81 && sum_1 <= 123) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_1 >= 150 && sum_1 <= 190) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_1 >= 290 && sum_1 <= 321) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_1 >= 331) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
