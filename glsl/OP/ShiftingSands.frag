...
float s5 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_0 >= 150 && sum_0 <= 155) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 135 && sum_0 <= 140) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 99 && sum_0 <= 118) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//EDGE_2
