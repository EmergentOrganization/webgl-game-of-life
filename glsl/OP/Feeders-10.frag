...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 62 && sum_0 <= 63) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_0 >= 109 && sum_0 <= 122) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_0 >= 168 && sum_0 <= 200) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
