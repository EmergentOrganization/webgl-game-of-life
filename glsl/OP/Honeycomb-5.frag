...
float s3 = 		getR(vec2(11.0, 16.0)) +
	...
	if(sum_0 >= 205 && sum_0 <= 999) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 160 && sum_0 <= 180) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 60 && sum_0 <= 80) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 48 && sum_0 <= 51) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 30 && sum_0 <= 45) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 22 && sum_0 <= 23) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
