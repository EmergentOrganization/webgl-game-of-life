...
float s5 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_0 >= 198 && sum_0 <= 270) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 165 && sum_0 <= 170) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 125 && sum_0 <= 130) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
