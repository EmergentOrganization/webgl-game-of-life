...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 29 && sum_0 <= 90) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 40 && sum_0 <= 42) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 97 && sum_0 <= 105) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 147 && sum_0 <= 152) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 17 && sum_1 <= 19) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 10 && sum_1 <= 10) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
