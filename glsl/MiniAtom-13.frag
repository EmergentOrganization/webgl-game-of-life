...
float s0 = 
	...
	if(sum_0 >= 29 && sum_0 <= 35) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); } 
	if(sum_0 > 48) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
//:17,17,1,
	...
	if(sum_1 >= 180 && sum_1 <= 220) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 97 && sum_1 <= 100) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 72 && sum_1 <= 74) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_1 == 23) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 150 && sum_1 <= 179) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 290) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
