...
float s3 = 		getR(vec2(7.0, -1.0)) +
	...
	int sum_0 = int(s0 + s1 + s2 + s3); //EDGE_0

	if(cgol <= 2) {gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);}
    if(cgol == 5) {gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}
    if(cgol == 8 && cgol == 8) {gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);}


	//if(sum_0 >= 79 && sum_0 <= 80) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_0 >= 69 && sum_0 <= 69) { gl_FragColor = vec4(1.0, 0.1, 0.9, 1.0); }	
	if(sum_0 >= 33 && sum_0 <= 33) { gl_FragColor = vec4(1.0, 0.6, 0.3, 1.0); }	
	if(sum_0 >= 133 && sum_0 <= 169) { gl_FragColor = vec4(1.0, 0.25, 0.0, 1.0); }
    if(sum_0 >= 139 && sum_0 <= 149) { gl_FragColor = vec4(1.0, 0.9, 0.3, 1.0); }

	if(sum_0 >= 76 && sum_0 <= 76) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 41 && sum_0 <= 51) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 175 && sum_0 <= 210) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 143 && sum_0 <= 150) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 250) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
