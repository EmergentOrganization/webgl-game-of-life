...
float s0 = 
	...
	if(sum_0 >= 28 && sum_0 <= 35) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); } 
	if(sum_0 > 40 && sum_0 < 47) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
//:17,17,1,
	...
	if(sum_1 >= 205 && sum_1 <= 285) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 124 && sum_1 <= 129) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 81 && sum_1 <= 86) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 62 && sum_1 <= 66) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 24 && sum_1 <= 25) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }

	if(sum_1 >= 95 && sum_1 <= 123) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
