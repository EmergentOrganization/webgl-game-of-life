...
float s4 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 170 && sum_1 <= 220) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 110 && sum_1 <= 150) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 82 && sum_1 <= 92) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 175) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 66 && sum_1 <= 77) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 165 && sum_1 <= 195) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
