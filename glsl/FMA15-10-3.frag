...
float s4 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 80 && sum_1 <= 92) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 37 && sum_1 <= 38) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 41 && sum_1 <= 43) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 127 && sum_1 <= 175) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
