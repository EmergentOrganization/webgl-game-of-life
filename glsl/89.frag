...
:10,13,0,*/
	...
	if(sum_0 >= 26) 				{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }

	if(sum_0 >= 22 && sum_0 <= 22) 	{ gl_FragColor = vec4(1.0, 0.5, 0.0, 1.0); }
	if(sum_0 >= 23 && sum_0 <= 23) 	{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
