...
float s3 = 		getR(vec2(7.0, -1.0)) +
    ...
    if(cgol >= 4 && cgol <= 5) {gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);}
   
	if(sum_0 >= 67 && sum_0 <= 90) { gl_FragColor = vec4(1.0, 0.8, 0.2, 1.0); }	
	if(sum_0 >= 119 && sum_0 <= 125) { gl_FragColor = vec4(1.0, 0.75, 0.0, 1.0); }
	if(sum_0 >= 145 && sum_0 <= 151) { gl_FragColor = vec4(1.0, 0.15, 1.0, 1.0); }
	
	if(sum_0 >= 69 && sum_0 <= 79) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
