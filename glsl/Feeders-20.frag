...
float s1 = 		getG(vec2(3.0, -2.0)) +
	...
	if(sum_0 >= 31 && sum_0 <= 36) { gl_FragColor = vec4(0.0, 1.0, 0.2, 1.0); }
...
float s5 = 		getG(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 95 && sum_1 <= 110) { gl_FragColor = vec4(0.8, 1.0, 0.2, 1.0); }	

	if(sum_1 >= 78 && sum_1 <= 86) { gl_FragColor = vec4(0.6, 0.0, 0.8, 1.0); }	
