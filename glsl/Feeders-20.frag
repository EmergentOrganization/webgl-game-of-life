...
float s1 = 		getR(vec2(3.0, -2.0)) +
	...
	if(sum_0 >= 31 && sum_0 <= 36) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 <= 15) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s5 = 		getR(vec2(7.0, -1.0)) +
	...
	//if(sum_1 >= 62 && sum_1 <= 63) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 95 && sum_1 <= 110) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	

	if(sum_1 >= 78 && sum_1 <= 86) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 125) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
