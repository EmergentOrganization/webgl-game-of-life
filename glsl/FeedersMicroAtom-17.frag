...
float s5 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_0 >= 125 && sum_0 <= 210) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	

	if(sum_0 >= 211) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 50 && sum_0 <= 124) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	
	if(sum_0 >= 65 && sum_0 <= 68) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 43 && sum_0 <= 43) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s9 = 		getR(vec2(7.0, -1.0)) +
		...
		getR(vec2(14.0, -1.0)) +
		getR(vec2(14.0, 0.0)) +
		getR(vec2(14.0, 1.0));   /*NEWLINE*/ int sum_1 = int(s6 + s7 + s8 + s9); //EDGE_0
...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_1 >= 40 && sum_1 <= 43) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 93 && sum_1 <= 155) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s10 = 
		...
		getR(vec2(3.0, -1.0)) +
		getR(vec2(3.0, 0.0)) +
		getR(vec2(3.0, 1.0));   /*NEWLINE*/ int sum_2 = int(s10); //EDGE_0


	if(sum_2 >= 12 && sum_2 <= 19) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	//if(sum_2 >= 9 && sum_2 <= 9) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
