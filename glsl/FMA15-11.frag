...
float s0 = 
	...
	if(sum_0 >= 1 && sum_0 <= 4) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s4 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 86 && sum_1 <= 195) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }

	//if(sum_1 >= 0 && sum_1 <= 30) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 41 && sum_1 <= 44) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }

	if(sum_1 >= 138) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 53 && sum_1 <= 75) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
