...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 0 && sum_0 <= 68) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 33 && sum_0 <= 37) { gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }
	if(sum_0 >= 79 && sum_0 <= 180) { gl_FragColor = vec4(0.5, 1.0, 0.0, 1.0); }
...
float s10 = 		getG(vec2(11.0, -9.0)) +
	...
	if(sum_2 >= 170) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
