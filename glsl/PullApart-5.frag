...
float s5 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_0 >= 145 && sum_0 <= 188) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 120 && sum_0 <= 122) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 <= 120) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 90 && sum_0 <= 93) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 68 && sum_0 <= 78) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
