...
:10,13,0,*/
	...
	if(sum_0 >= 27) 				{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }

	if(sum_0 >= 21 && sum_0 <= 25) 	{ gl_FragColor = vec4(1.0, 0.5, 0.0, 1.0); }
	if(sum_0 >= 21 && sum_0 <= 22) 	{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 8 && sum_0 <= 8) 	{ gl_FragColor = vec4(1.0, 0.8, 0.4, 1.0); }
