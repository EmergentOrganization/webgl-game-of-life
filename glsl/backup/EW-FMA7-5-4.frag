...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 0 && sum_0 <= 83) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 35 && sum_0 <= 39) { gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }
	if(sum_0 >= 84 && sum_0 <= 100) { gl_FragColor = vec4(0.5, 1.0, 0.0, 1.0); }
	if(sum_0 >= 101 && sum_0 <= 101) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
