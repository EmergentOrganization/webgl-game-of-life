...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 0 && sum_0 <= 82) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }

	if(sum_0 >= 35 && sum_0 <= 39) { gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }

	if(sum_0 >= 87 && sum_0 <= 112) { gl_FragColor = vec4(0.5, 1.0, 0.0, 1.0); }
	//if(sum_0 >= 111 && sum_0 <= 125) { gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0); }
...
float s10 = 		getG(vec2(11.0, -9.0)) +
	...
	if(sum_2 >= 200) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
