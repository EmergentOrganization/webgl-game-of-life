...
float s3 = 		getG(vec2(7.0, -1.0)) +
	...
	if(sum_0 >= 175) { gl_FragColor = vec4(0.0, 0.0, 0.5, 1.0); }

	if(sum_0 >= 67 && sum_0 <= 67) { gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0); }	
	if(sum_0 >= 104 && sum_0 <= 150) { gl_FragColor = vec4(0.7, 1.0, 0.4, 1.0); }
	if(sum_0 >= 124 && sum_0 <= 140) { gl_FragColor = vec4(0.2, 1.0, 0.7, 1.0); }	

	if(sum_0 >= 81 && sum_0 <= 104) { gl_FragColor = vec4(0.4, 0.0, 0.5, 1.0); }	
	if(sum_0 >= 88 && sum_0 <= 92) { gl_FragColor = vec4(0.8, 0.0, 0.8, 1.0); }	
	if(sum_0 >= 95 && sum_0 <= 104) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
