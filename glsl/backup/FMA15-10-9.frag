...
float s0 = 
	...
	if(sum_0 >= 16 && sum_0 <= 16) 	{ gl_FragColor = vec4(1.0, 0.4, 1.0, 1.0); }	//14, 17
	if(sum_0 >= 14 && sum_0 <= 14) 	{ gl_FragColor = vec4(1.0, 0.8, 0.0, 1.0); }	//14, 17
	if(sum_0 >= 15 && sum_0 <= 15) 	{ gl_FragColor = vec4(1.0, 0.2, 0.0, 1.0); }	//14, 17
