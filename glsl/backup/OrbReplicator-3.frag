...
:10,13,0,*/
	...
	if(sum_0 >= 22 && sum_0 <= 25) 	{ gl_FragColor = vec4(1.0, 0.5, 0.0, 1.0); }
	if(sum_0 >= 22 && sum_0 <= 22) 	{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 8 && sum_0 <= 8) 	{ gl_FragColor = vec4(1.0, 0.9, 0.9, 1.0); }

	if(sum_0 >= 0 && sum_0 <= 4) 	{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 5 && sum_0 <= 7) 	{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 9 && sum_0 <= 14) 	{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
