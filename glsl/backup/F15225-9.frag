...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 7 && sum_0 <= 21) { gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }
	if(sum_0 >= 800 && sum_0 <= 250) { gl_FragColor = vec4(1.0, 0.0, 1.0, 1.0); }
...
float s5 = 
	...
	if(sum_2 >= 25 && sum_2 <= 35) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_2 >= 16 && sum_2 <= 19) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
	if(sum_2 >= 1 && sum_2 <= 6) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
...
float s6 = 
	...
	if(sum_3 >= 41) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
