...
float s3 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_0 >= 44 && sum_0 <= 45) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 71 && sum_0 <= 79) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 147) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
