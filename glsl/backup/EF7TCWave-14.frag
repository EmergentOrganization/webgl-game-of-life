...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 0 && sum_0 <= 85) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 37 && sum_0 <= 42) { gl_FragColor = vec4(1.0, 0.7, 0.0, 1.0); }
	if(sum_0 >= 79 && sum_0 <= 81) { gl_FragColor = vec4(1.0, 0.3, 0.8, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 11 && sum_1 <= 15) { gl_FragColor = vec4(1.0, 0.8, 0.8, 1.0); }	
...
float s6 = 		getR(vec2(3.0, -2.0)) +
	...
	if(sum_2 >= 44 && sum_2 <= 62) { gl_FragColor = vec4(1.0, 0.2, 0.0, 1.0); }	
...
float s12 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_3 >= 155 && sum_3 <= 185) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
