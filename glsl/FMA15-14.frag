...
float s1 = 
	...
	if(sum_1 >= 14 && sum_1 <= 14) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 26) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 0 && sum_1 <= 12) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
