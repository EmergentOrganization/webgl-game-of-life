...
void main() {
	...
	if(f0 >= 7 && f0 <= 7) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(f0 >= 0 && f0 <= 3) 		{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(f1 >= 12 && f1 <= 14) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(f1 >= 20 && f1 <= 99) 		{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(f1 >= 0 && f1 <= 1) 		{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
