...
// 4b 	solids with 5/8 non-water/non-solid moore spaces move horizontally into empty cell, else stay still
	...
	if(g != 0.0) {
		...
		if(getR(vec2(0.0, 1.0), state) != 0.0 || (getG(vec2(0.0, 1.0), state) == 0.0 && getB(vec2(0.0, 1.0), state) == 0.0)){	moore_count += 1; }
		if(getR(vec2(1.0, 0.0), state) != 0.0 || (getG(vec2(1.0, 0.0), state) == 0.0 && getB(vec2(1.0, 0.0), state) == 0.0)){	moore_count += 1; }
		if(getR(vec2(1.0, 1.0), state) != 0.0 || (getG(vec2(1.0, 1.0), state) == 0.0 && getB(vec2(1.0, 1.0), state) == 0.0)){	moore_count += 1; }
		if(getR(vec2(0.0, -1.0), state) != 0.0 || (getG(vec2(0.0, -1.0), state) == 0.0 && getB(vec2(0.0, -1.0), state) == 0.0)){	moore_count += 1; }
		if(getR(vec2(-1.0, 0.0), state) != 0.0 || (getG(vec2(-1.0, 0.0), state) == 0.0 && getB(vec2(-1.0, 0.0), state) == 0.0)){	moore_count += 1; }
		if(getR(vec2(-1.0, -1.0), state) != 0.0 || (getG(vec2(-1.0, -1.0), state) == 0.0 && getB(vec2(-1.0, -1.0), state) == 0.0)){	moore_count += 1; }
		if(getR(vec2(1.0, -1.0), state) != 0.0 || (getG(vec2(1.0, -1.0), state) == 0.0 && getB(vec2(1.0, -1.0), state) == 0.0)){	moore_count += 1; }
		...
		if(moore_count == 5) { 
			...
			if(getR(vec2(-1.0, 0.0), state) != 0.0 || getG(vec2(-1.0, 0.0), state) != 0.0 || getB(vec2(-1.0, 0.0), state) != 0.0){	elem += 1; }
	...
	if(r == 0.0 && g == 0.0 && b == 0.0) {
		if(getG(vec2(-1.0, 0.0), state) != 0.0) {
			...
			if(getR(vec2(-1.0, 1.0), state) != 0.0 || (getG(vec2(-1.0, 1.0), state) == 0.0 && getB(vec2(-1.0, 1.0), state) == 0.0)){	moore_count2 += 1; }
			if(getR(vec2(0.0, 0.0), state) != 0.0 || (getG(vec2(0.0, 0.0), state) == 0.0 && getB(vec2(0.0, 0.0), state) == 0.0)){	moore_count2 += 1; }
			if(getR(vec2(0.0, 1.0), state) != 0.0 || (getG(vec2(0.0, 1.0), state) == 0.0 && getB(vec2(0.0, 1.0), state) == 0.0)){	moore_count2 += 1; }
			if(getR(vec2(-1.0, -1.0), state) != 0.0 || (getG(vec2(-1.0, -1.0), state) == 0.0 && getB(vec2(-1.0, -1.0), state) == 0.0)){	moore_count2 += 1; }
			if(getR(vec2(-2.0, 0.0), state) != 0.0 || (getG(vec2(-2.0, 0.0), state) == 0.0 && getB(vec2(-2.0, 0.0), state) == 0.0)){	moore_count2 += 1; }
			if(getR(vec2(-2.0, -1.0), state) != 0.0 || (getG(vec2(-2.0, -1.0), state) == 0.0 && getB(vec2(-2.0, -1.0), state) == 0.0)){	moore_count2 += 1; }
			if(getR(vec2(0.0, -1.0), state) != 0.0 || (getG(vec2(0.0, -1.0), state) == 0.0 && getB(vec2(0.0, -1.0), state) == 0.0)){	moore_count2 += 1; }
			if(getR(vec2(-2.0, 1.0), state) != 0.0 || (getG(vec2(-2.0, 1.0), state) == 0.0 && getB(vec2(-2.0, 1.0), state) == 0.0)){	moore_count2 += 1; }
		...
		if(getG(vec2(1.0, 0.0), state) != 0.0) {
			...
			if(getR(vec2(1.0, 1.0), state) != 0.0 || (getG(vec2(1.0, 1.0), state) == 0.0 && getB(vec2(1.0, 1.0), state) == 0.0)){	moore_count3 += 1; }
			if(getR(vec2(2.0, 0.0), state) != 0.0 || (getG(vec2(2.0, 0.0), state) == 0.0 && getB(vec2(2.0, 0.0), state) == 0.0)){	moore_count3 += 1; }
			if(getR(vec2(2.0, 1.0), state) != 0.0 || (getG(vec2(2.0, 1.0), state) == 0.0 && getB(vec2(2.0, 1.0), state) == 0.0)){	moore_count3 += 1; }
			if(getR(vec2(1.0, -1.0), state) != 0.0 || (getG(vec2(1.0, -1.0), state) == 0.0 && getB(vec2(1.0, -1.0), state) == 0.0)){	moore_count3 += 1; }
			if(getR(vec2(0.0, 0.0), state) != 0.0 || (getG(vec2(0.0, 0.0), state) == 0.0 && getB(vec2(0.0, 0.0), state) == 0.0)){	moore_count3 += 1; }
			if(getR(vec2(0.0, -1.0), state) != 0.0 || (getG(vec2(0.0, -1.0), state) == 0.0 && getB(vec2(0.0, -1.0), state) == 0.0)){	moore_count3 += 1; }
			if(getR(vec2(2.0, -1.0), state) != 0.0 || (getG(vec2(2.0, -1.0), state) == 0.0 && getB(vec2(2.0, -1.0), state) == 0.0)){	moore_count3 += 1; }
			if(getR(vec2(0.0, 1.0), state) != 0.0 || (getG(vec2(0.0, 1.0), state) == 0.0 && getB(vec2(0.0, 1.0), state) == 0.0)){	moore_count3 += 1; }
