...
//:17,17,1,
	...
	if(sum_0 >= 31 && sum_0 <= 53) 	{ gl_FragColor = vec4(0.2, 0.4, 1.0, 1.0); } 
	//if(sum_0 >= 34 && sum_0 <= 38) 	{ gl_FragColor = vec4(0.6, 1.0, 1.0, 1.0); } 
	if(sum_0 > 45 && sum_0 <= 54) 					{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 < 23) 					{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }


	if(sum_1 >= 160 && sum_1 <= 170) 	{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }

	if(sum_1 >= 180 && sum_1 <= 280) 	{ gl_FragColor = vec4(0.5, 0.0, 1.0, 1.0); }
	//if(sum_1 >= 248 && sum_1 <= 280) 	{ gl_FragColor = vec4(0.0, 0.3, 1.0, 1.0); }
	//if(sum_1 >= 268 && sum_1 <= 290) 	{ gl_FragColor = vec4(0.6, 0.3, 1.0, 1.0); }
	if(sum_1 >= 81 && sum_1 <= 83) 		{ gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0); }
	if(sum_1 >= 50 && sum_1 <= 52) 		{ gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0); }
	//if(sum_1 == 40) 					{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }
	if(sum_1 >= 320) 					{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
