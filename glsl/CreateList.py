...
class CreateList:	
	...
	def ignore_elements(self, files):
		ignores = ['copy.frag', 'trails.frag', 'ConstInterf.frag', 'PlaceSegs.frag', 'ViewRadius.frag', 'ShiftCells.frag', 'ShiftCells_2.frag', 'PlaceCells.frag', 'PlaceCircle.frag', 'RendMerge3.frag', 'DestInterf.frag', 'quad.vert', 'photo.frag']
		restart = False
		for f in files:
			if restart:
				break
