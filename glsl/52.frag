...
float s3 = 		getB(vec2(7.0, -1.0)) +
	...
	if(sum_0 >= 119 && sum_0 <= 122) { gl_FragColor = vec4(0.7, 0.3, 1.0, 1.0); }
	if(sum_0 >= 133 && sum_0 <= 158) { gl_FragColor = vec4(0.2, 0.8, 1.0, 1.0); }	

	if(sum_0 >= 0 && sum_0 <= 70) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
