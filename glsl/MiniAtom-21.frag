...
float s0 = 
	...
	if(sum_0 >= 29 && sum_0 <= 34) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); } 
	if(sum_0 >= 16 && sum_0 <= 26) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s7 = 		getR(vec2(16.0, 11.0)) +
	...
	if(sum_1 >= 183 && sum_1 <= 290) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 101 && sum_1 <= 103) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 70 && sum_1 <= 74) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 55 && sum_1 <= 65) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 220) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
