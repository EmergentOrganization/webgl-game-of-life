...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 80 && sum_0 <= 83) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 123 && sum_0 <= 130) 		{ gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 17 && sum_1 <= 23) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
