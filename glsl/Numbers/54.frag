...
float s1 = 		getG(vec2(3.0, -2.0)) +
	...
	if(sum_0 >= 30 && sum_0 <= 44) { gl_FragColor = vec4(0.4, 1.0, 0.8, 1.0); }
...
float s5 = 		getG(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 62 && sum_1 <= 63) { gl_FragColor = vec4(0.4, 1.0, 0.0, 1.0); }	
	if(sum_1 >= 75 && sum_1 <= 185) { gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0); }
	if(sum_1 >= 88 && sum_1 <= 115) { gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }	
	if(sum_1 >= 150 && sum_1 <= 165) { gl_FragColor = vec4(0.8, 1.0, 0.8, 1.0); }	
