...
float s0 = 
	...
	if(sum_0 >= 11 && sum_0 <= 13) 	{ gl_FragColor = vec4(1.0, 0.0, 1.0, 1.0); }	//14, 17
...
float s4 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 42 && sum_1 <= 43) 			{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }
	if(sum_1 >= 81 && sum_1 <= 127) 			{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }
