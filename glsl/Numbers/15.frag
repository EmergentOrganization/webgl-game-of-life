...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 22 && sum_0 <= 75) { gl_FragColor = vec4(0.0, 0.0, 0.2, 1.0); }
	if(sum_0 >= 30 && sum_0 <= 45) { gl_FragColor = vec4(0.0, 0.2, 0.7, 1.0); }
	if(sum_0 >= 68 && sum_0 <= 71) { gl_FragColor = vec4(1.0, 1.0, 0.0, 1.0); }
	if(sum_0 >= 95 && sum_0 <= 115) { gl_FragColor = vec4(0.0, 0.6, 0.8, 1.0); }
	if(sum_0 >= 137 && sum_0 <= 149) { gl_FragColor = vec4(1.0, 0.5, 0.2, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 13 && sum_1 <= 19) { gl_FragColor = vec4(1.0, 0.8, 0.0, 1.0); }	
	if(sum_1 >= 9 && sum_1 <= 9) { gl_FragColor = vec4(0.0, 0.4, 0.2, 1.0); }	
...
float s10 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_2 >= 245) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
