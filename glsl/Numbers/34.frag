...
float s3 = 		getR(vec2(7.0, -1.0)) +
    ...
    if(cgol == 4) {gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}
    if(cgol >= 6 && cgol <= 6) {gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);}

	if(sum_0 >= 37 && sum_0 <= 43) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	
	if(sum_0 >= 77 && sum_0 <= 89) { gl_FragColor = vec4(1.0, 0.99, 0.2, 1.0); }	
	if(sum_0 >= 46 && sum_0 <= 46) { gl_FragColor = vec4(1.0, 0.1, 0.9, 1.0); }	
	if(sum_0 >= 33 && sum_0 <= 33) { gl_FragColor = vec4(1.0, 0.6, 0.3, 1.0); }	
	if(sum_0 >= 121 && sum_0 <= 126) { gl_FragColor = vec4(1.0, 0.25, 0.0, 1.0); }
	//if(sum_0 >= 139 && sum_0 <= 149) { gl_FragColor = vec4(1.0, 0.9, 0.3, 1.0); }

	if(sum_0 >= 39 && sum_0 <= 76) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 84 && sum_0 <= 88) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 143 && sum_0 <= 150) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 137 && sum_0 <= 182) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 153) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
