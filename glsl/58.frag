...
float s3 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_0 >= 50) 				{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 0 && sum_0 <= 20) 	{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 35 && sum_0 <= 40) 	{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	//if(sum_1 >= 14 && sum_1 <= 15) 	{ gl_FragColor = vec4(1.0, 1.0, 0.0, 1.0); }	
	if(sum_1 >= 20 && sum_1 <= 22) 	{ gl_FragColor = vec4(1.0, 1.0, 0.0, 1.0); }	
