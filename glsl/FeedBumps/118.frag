...
float s3 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_0 >= 22 && sum_0 <= 33) { gl_FragColor = vec4(0.0, 1.0, 0.7, 1.0); }	
	if(sum_0 >= 111 && sum_0 <= 112) { gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0); }
	if(sum_0 >= 71 && sum_0 <= 77) { gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }
	if(sum_0 >= 143) { gl_FragColor = vec4(0.0, 0.0, 1.0, 1.0); }
    
	if(sum_0 >= 80 && sum_0 <= 83) { gl_FragColor = vec4(1.0, 0.8, 0.2, 1.0); }	
	if(sum_0 >= 51 && sum_0 <= 51) { gl_FragColor = vec4(1.0, 0.8, 0.3, 1.0); }	
	if(sum_0 >= 31 && sum_0 <= 31) { gl_FragColor = vec4(1.0, 0.8, 0.3, 1.0); }	
	if(sum_0 >= 23 && sum_0 <= 23) { gl_FragColor = vec4(1.0, 0.2, 1.0, 1.0); }		
