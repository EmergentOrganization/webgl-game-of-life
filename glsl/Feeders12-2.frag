...
void main() {
	...
	if(sum_one >= 110 && sum_one <= 149) 	{gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}
	//if(sum_one >= 65 && sum_one <= 66) 		{gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}
	if(sum_one >= 79 && sum_one <= 80) 		{gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}
	//if(sum_one >= 23 && sum_one <= 23) 		{gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}

	if(sum_one >= 157) 					{gl_FragColor = vec4(0.0, 0.0, 1.0, 1.0);}
	if(sum_one >= 40 && sum_one <= 55) 	{gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0);}
	if(sum_one >= 88 && sum_one <= 89) 	{gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0);}
