...
void main() {
	...
	if(sum_one >= 91 && sum_one <= 155) 	{gl_FragColor = vec4(1.0, 1.0, 0.0, 1.0);}

	if(sum_two >= 13 && sum_two <= 19) 		{gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}	
	if(sum_two >= 9 && sum_two <= 9) 		{gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);}	

	if(sum_three >= 185) 					{gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);}
