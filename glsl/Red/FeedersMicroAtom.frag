...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 127 && sum_0 <= 189) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 11 && sum_1 <= 17) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	

	if(sum_1 >= 5 && sum_1 <= 5) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
