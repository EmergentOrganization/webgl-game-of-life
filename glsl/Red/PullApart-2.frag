...
float s5 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_0 >= 170 && sum_0 <= 210) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 130 && sum_0 <= 140) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 <= 120) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 60 && sum_0 <= 70) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
