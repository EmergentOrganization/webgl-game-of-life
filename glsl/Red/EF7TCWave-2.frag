...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_2 >= 30 && sum_2 <= 80) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 40 && sum_2 <= 42) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_2 >= 49 && sum_2 <= 50) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 95 && sum_2 <= 191) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s8 = 		getR(vec2(3.0, -2.0)) +
	...
	if(sum_4 >= 15 && sum_4 <= 27) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
	//if(sum_4 >= 9 && sum_4 <= 9) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
...
float s14 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_5 >= 185 && sum_5 <= 235) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
