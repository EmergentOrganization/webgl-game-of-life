...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_2 >= 20 && sum_2 <= 90) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 38 && sum_2 <= 46) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_2 >= 49 && sum_2 <= 50) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 84 && sum_2 <= 152) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
