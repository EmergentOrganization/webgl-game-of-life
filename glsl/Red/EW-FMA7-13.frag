...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 31 && sum_0 <= 72) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 88 && sum_0 <= 155) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 41 && sum_0 <= 42) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 79 && sum_0 <= 81) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 119 && sum_0 <= 159) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 84 && sum_0 <= 118) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 14 && sum_1 <= 19) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 8 && sum_1 <= 8) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
...
float s10 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_2 >= 215) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 239 && sum_2 <= 290) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
