...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 101 && sum_0 <= 155) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 25 && sum_0 <= 66) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 79 && sum_0 <= 80) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	//if(sum_0 == 23) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	
	if(sum_0 >= 30 && sum_0 <= 100) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 100 && sum_0 <= 100) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 160) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 29 && sum_0 <= 71) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 13 && sum_1 <= 20) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
