...
float s3 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_0 >= 155) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }

	if(sum_0 >= 67 && sum_0 <= 68) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_0 >= 86 && sum_0 <= 172) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	

	if(sum_0 >= 81 && sum_0 <= 105) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
