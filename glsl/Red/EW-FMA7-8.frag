...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 79 && sum_0 <= 86) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 119 && sum_0 <= 985) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s10 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_2 >= 209 && sum_2 <= 300) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
