...
float s1 = 		getR(vec2(3.0, -2.0)) +
	...
	if(sum_0 >= 30 && sum_0 <= 40) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
...
float s5 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 115 && sum_1 <= 120) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	

	if(sum_1 >= 78 && sum_1 <= 86) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 145) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
