...
float s4 = 		getR(vec2(7.0, -1.0)) +
	...
	//if(sum_1 >= 175 && sum_1 <= 200) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 75 && sum_1 <= 107) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 85 && sum_1 <= 92) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 41 && sum_1 <= 44) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 103 && sum_1 <= 165) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 180) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_1 >= 19 && sum_1 <= 19) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 34 && sum_1 <= 35) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
