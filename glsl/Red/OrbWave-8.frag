...
float s5 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_0 >= 129 && sum_0 <= 186) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 <= 100) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 89 && sum_0 <= 92) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 77 && sum_0 <= 79) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
