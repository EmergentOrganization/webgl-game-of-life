...
float s3 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_0 >= 62 && sum_0 <= 66) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 75 && sum_0 <= 120) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 14 && sum_1 <= 17) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 9 && sum_1 <= 9) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	

	if(sum_1 >= 18) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 0 && sum_1 <= 4) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 7 && sum_1 <= 8) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
