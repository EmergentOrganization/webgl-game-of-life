...
//:17,17,1,
	...
	if(sum_1 >= 195 && sum_1 <= 300) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 124 && sum_1 <= 125) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 99 && sum_1 <= 101) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 81 && sum_1 <= 87) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
