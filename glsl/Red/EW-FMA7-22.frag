...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 31 && sum_0 <= 131) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 42 && sum_0 <= 43) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 121 && sum_0 <= 139) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
