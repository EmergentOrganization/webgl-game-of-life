...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 30 && sum_0 <= 900) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 37 && sum_0 <= 39) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 69 && sum_0 <= 70) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
