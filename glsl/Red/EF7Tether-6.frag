...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 32 && sum_0 <= 110) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 40 && sum_0 <= 41) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 89 && sum_0 <= 95) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
