...
float s5 = 		getR(vec2(11.0, -9.0)) +
	...
	if(sum_0 >= 230 && sum_0 <= 359) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 135 && sum_0 <= 144) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 124 && sum_0 <= 125) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
