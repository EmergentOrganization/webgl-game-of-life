...
//Get gliders to be birthed from wave's crystal form
	...
	//if(sum_0 >= 52) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 52 && sum_0 <= 58) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 71 && sum_0 <= 295) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_0 >= 262) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 12 && sum_1 <= 17) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_1 >= 2 && sum_1 <= 4) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s5 = 
	...
	if(sum_2 >= 21 && sum_2 <= 31) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_2 >= 8 && sum_2 <= 8) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_2 >= 10 && sum_2 <= 16) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
...
float s6 = 
	...
	if(sum_3 >= 32 && sum_3 <= 39) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
