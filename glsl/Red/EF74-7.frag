...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 0 && sum_0 <= 75) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 70 && sum_0 <= 72) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 95 && sum_0 <= 115) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 132 && sum_0 <= 149) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
