...
float s4 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 94 && sum_1 <= 135) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_1 >= 37 && sum_1 <= 38) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 17 && sum_1 <= 17) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_1 >= 29 && sum_1 <= 29) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
