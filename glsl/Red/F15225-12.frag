...
float s4 = 
	...
	if(sum_1 >= 10 && sum_1 <= 12) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
...
float s5 = 
	...
	//if(sum_2 >= 39 && sum_2 <= 39) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_2 >= 0 && sum_2 <= 16) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
