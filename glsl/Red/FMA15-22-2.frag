...
float s2 = 
	...
	//if(sum_2 >= 11 && sum_2 <= 12) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
	//if(sum_2 >= 22 && sum_2 <= 22) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }	
	if(sum_2 >= 34) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
