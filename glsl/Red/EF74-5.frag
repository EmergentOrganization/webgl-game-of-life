...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 42 && sum_0 <= 95) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 69 && sum_0 <= 77) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_0 >= 95 && sum_0 <= 115) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
...
float s4 = 
	...
	if(sum_1 >= 9 && sum_1 <= 9) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }	
