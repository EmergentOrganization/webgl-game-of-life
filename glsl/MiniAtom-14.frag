...
//:17,17,1,
	...
	if(sum_1 >= 190 && sum_1 <= 280) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 95 && sum_1 <= 98) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 70 && sum_1 <= 72) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_1 == 23) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 150 && sum_1 <= 149) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 310) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
