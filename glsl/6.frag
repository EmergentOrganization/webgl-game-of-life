...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_0 >= 40 && sum_0 <= 42) { gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }
	if(sum_0 >= 88 && sum_0 <= 155) { gl_FragColor = vec4(0.5, 1.0, 0.0, 1.0); }
	if(sum_0 >= 111 && sum_0 <= 145) { gl_FragColor = vec4(0.0, 1.0, 1.0, 1.0); }
