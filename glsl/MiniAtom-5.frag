...
float s0 = 
	...
	if(sum_0 >= 24 && sum_0 <= 43) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); } 
...
//:17,17,1,
	...
	if(sum_1 >= 63 && sum_1 <= 64) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 == 19) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 340) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
