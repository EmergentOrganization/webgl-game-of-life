...
float s0 = 
	...
	if(sum_0 >= 10 && sum_0 <= 16) 	{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }	//14, 17

	if(sum_0 >= 17 && sum_0 <= 24) 	{ gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); }
...
float s4 = 		getR(vec2(7.0, -1.0)) +
	...
	if(sum_1 >= 15 && sum_1 <= 19) 			{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }

	if(sum_1 >= 63 && sum_1 <= 78) 			{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_1 >= 16 && sum_1 <= 22) 			{ gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }

	if(sum_1 >= 59 && sum_1 <= 59) 			{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }
	//if(sum_1 >= 43 && sum_1 <= 45) 		{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }
	if(sum_1 >= 87 && sum_1 <= 157) 		{ gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }
