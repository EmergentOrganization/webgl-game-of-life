...
//Get gliders to be birthed from wave's crystal form
	...
	if(sum_2 >= 29 && sum_2 <= 90) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 37 && sum_2 <= 29) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	//if(sum_2 >= 49 && sum_2 <= 50) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
	if(sum_2 >= 80 && sum_2 <= 191) { gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); }
